...
def insertIntoDB(db, cursor, image, dense, dense1, outputs):
    sql = "INSERT INTO " + coronet_test_table + "(image_name, dense, dense_1, class) VALUES (%s, %s, %s, %s)"
...
x_train, y_train, path_train = genDataset3DWithNames(normal_test_path, bacterial_test_path, viral_test_path, covid_test_path)
